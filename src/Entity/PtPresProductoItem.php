 ...
 * PtPresProductoItem
 *
 * @ORM\Table(name="pt_pres_producto_item")
 * @ORM\Entity
 */
class PtPresProductoItem
{
    /**
     * @var int
     *
     ...
     * @var string
     *
     * @ORM\Column(name="num_personas", type="decimal", precision=10, scale=4, nullable=false, options={"default"="0.0000"})
     */
    private $numPersonas = '0.0000';
