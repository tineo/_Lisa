 ...
 * Proyectos
 *
 * @ORM\Table(name="proyectos", indexes={@ORM\Index(name="b", columns={"account_id"}), @ORM\Index(name="a", columns={"opportunity_id"})})
 * @ORM\Entity
 */
class Proyectos
{
     ...
     * @var string|null
     *
     * @ORM\Column(name="monto_facturado", type="decimal", precision=11, scale=2, nullable=true, options={"default"="0.00"})
     */
